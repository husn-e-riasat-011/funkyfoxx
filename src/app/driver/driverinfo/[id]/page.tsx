      ...
      <div className="mx-auto max-w-242.5">
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          <div className="relative z-20 h-35 md:h-65">
            ...
            <Link
              href={`/driver/edit/${id} `}
              className="absolute bottom-1 right-1 z-10 cursor-pointer xsm:bottom-[-35px] xsm:right-10"
            >
              <span className="bg-blue-600 px-2 py-1 text-whiten">
                Edit Profile
              </span>
            </Link>
          </div>
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              <p className="mb-1.5 text-2xl font-semibold text-black dark:text-white">
                Driver Information
              </p>
              <h1 className="font-bold ">{driver.driverName}</h1>
              <div className="mx-auto mb-5.5 mt-4.5 grid grid-cols-3 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
                <div className=" items-center gap-1 border-r border-stroke px-2 dark:border-strokedark xsm:flex-row">
                  <p className="mb-2">licenseNumber</p>
                ...
                <div className="items-center gap-1 px-2 xsm:flex-row">
              ...
              <div className="mx-auto max-w-180">
                ...
                <p className="mt-4.5">{driver.address}</p>
              </div>
